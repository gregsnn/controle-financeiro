...
import { buildBillPaymentMap, buildSummaryData } from '../selectors/summarySelectors.js';
...
export default function Summary({
  ...
  const billPaymentMap = useMemo(
    () => buildBillPaymentMap(monthOverrides, currentMonthKey),
    [monthOverrides, currentMonthKey]
  );
