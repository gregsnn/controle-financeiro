...
describe('chartSeries.js', () => {
  ...
  describe('buildCategorySeries', () => {
    it('returns empty series with no expenses', () => {
      const result = buildCategorySeries({ fixedExpenses: [], installments: [] });
    ...
    it('groups expenses by category', () => {
      const result = buildCategorySeries({
        fixedExpenses: [
          { id: '1', name: 'Aluguel', amount: 1500, category: 'casa', paymentMethod: 'boleto', active: true, startMonth: '2026-01', endMonth: null, dueDay: 5, notes: '' },
          { id: '2', name: 'Internet', amount: 120, category: 'telefone', paymentMethod: 'pix', active: true, startMonth: '2026-01', endMonth: null, dueDay: 5, notes: '' },
        ],
        installments: []
      });
